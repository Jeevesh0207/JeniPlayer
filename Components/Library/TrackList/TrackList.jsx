...
import createStyles from './StyleTrackList';
...
const TrackSearch = () => {
  ...
  const { songs:tracks } = useSelector((state) => state.getFavouriteSong);
  ...
  const renderBox = useCallback(
    ...
    [styles, colors, dispatch,currentTrackId,addtofavourite,songsArrayId]
  );
    ...
    <GestureHandlerRootView style={styles.container}>
      <View style={[styles.makecenter, styles.head]}>
        ...
        <View style={[styles.makecenter, styles.head_title_box]}>
          <Text style={styles.head_title_text}>Your Library</Text>
        </View>
      </View>
